// Tratar exceções (erros inesperados) para que não interfira no funcionamento da aplicação. 

class AppError {
  // Cria as variáveis no topo da classe, faz com que toda a classe tome conhecimento delas, conseguindo acessá-las dentro de qualquer outra funcionalidade.
  message;
  statusCode;
